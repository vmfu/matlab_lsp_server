...
BUILTIN_FUNCTIONS = {
    ...
    'exp', 'factorial', 'floor', 'gcd', 'hypot', 'log', 'log10', 'log2',
    'max', 'min', 'mod', 'nthroot', 'pow', 'prod', 'real', 'rem',
    'round', 'sec', 'sech', 'sign', 'sin', 'sinh', 'sqrt', 'tan',
    'tanh', 'eye', 'ones', 'zeros', 'rand', 'randn', 'linspace',
    'linspace', 'logspace', 'meshgrid', 'ndgrid', 'eig', 'eigs',
    'svd', 'lu', 'qr', 'chol', 'eig', 'fft', 'ifft', 'fft2',
    'ifft2', 'cell', 'struct', 'num2cell', 'num2struct', 'size',
    'length', 'ndims', 'numel', 'isa', 'isnumeric', 'ischar',
    'islogical', 'isinteger', 'isfloat', 'strfind', 'strcmp', 'strncmp',
    'strrep', 'lower', 'upper', 'char', 'double', 'single', 'int8',
    'int16', 'int32', 'int64', 'uint8', 'uint16', 'uint32', 'uint64',
    'logical', 'sparse', 'full', 'cat', 'horzcat', 'vertcat', 'permute',
    'ipermute', 'reshape', 'squeeze', 'sub2ind', 'ind2sub', 'shiftdim',
    'circshift', 'find', 'cumsum', 'cumprod', 'diff', 'repmat',
    'kron', 'all', 'any', 'exist', 'strcmpi', 'strmatch',
    'datestr', 'datenum', 'datevec', 'weekday', 'calendar', 'clock',
    'etime', 'cputime', 'tic', 'toc', 'pause', 'drawnow',
    'save', 'load', 'clear', 'close', 'fopen', 'fclose', 'fprintf',
    'fscanf', 'fgets', 'disp', 'input', 'keyboard', 'error', 'warning',
    'help', 'doc', 'which', 'type', 'ver', 'license', 'version',
}
...
MATLAB_KEYWORDS = {
    ...
    'events', 'enumeration', 'import', 'export', 'package',
}
